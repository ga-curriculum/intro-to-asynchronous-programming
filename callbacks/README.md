...
**Learning Objective:** By the end of this lesson, students will understand using callback functions to construct asynchronous JavaScript.

## Understanding callbacks in asynchronous JavaScript

A callback is a function passed into another function as an argument so it may be invoked at the appropriate time. Many JavaScript functions are designed to use callbacks, including browser event handling and asynchronous requests like reading files.
...
`fs` is Node's built-in file system module. It allows our app to interact interaction with the file system.
